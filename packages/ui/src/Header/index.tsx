            ...
            <div className="relative w-full flex justify-between mx-auto max-w-7xl md:px-4">
                ...
                <div className="flex flex-row items-center max-md:hidden">
                    <nav className="flex items-center text-white">
                        {/* <Link href={`/about`} className='prose text-black prose-PicnicText mx-2'>
                            <p>About Picnic</p>
                        </Link> */}
                        {/* <Link href={`/working-at-picnic`} className='prose text-black prose-PicnicText mx-2'>
                            <p>Picnic as Employer</p>
                        </Link>
                        <Link href={`/teams`} className='prose text-black prose-PicnicText mx-2'>
                            <p>Teams</p>
                        </Link>
                        <Link href={`/tech`} className='prose text-black prose-PicnicText mx-2'>
                            <p>Tech</p>
                        </Link>
                        <Link href={`/de`} className='prose text-black prose-PicnicText mx-2'>
                            <p>LANG</p>
                        </Link>
                        <Link href={`/jobs`} className='bg-greenish text-white rounded rounded-full mx-2 px-4 py-2'>
                            <p>All jobs</p>
                        </Link> */}
                    </nav>
                </div>
                ...
                <div className="sm:hidden md:visible lg:visible xl:visible 2xl:visible z-10 float-right">
                    ...
                    <aside className="fixed top-0 bg-white w-full h-full -right-full peer-checked:right-0 ease-out delay-150 duration-300">
                        ...
                        {/* <Link href={`/jobs`} className='prose text-black prose-PicnicText mx-1 text-black'>
                            <p>Jobs</p>
                        </Link>
                        <Link href={`/teams`} className='prose text-black prose-PicnicText mx-1 text-black'>
                            <p>Teams</p>
                        </Link>
                        <Link href={`/cities/amsterdam`} className='prose text-black prose-PicnicText mx-1 text-black'>
                            <p>Cities</p>
                        </Link>
                        <Link href={`/contact`} className='prose text-black prose-PicnicText mx-1 text-black'>
                            <p>Contact</p>
                        </Link> */}
